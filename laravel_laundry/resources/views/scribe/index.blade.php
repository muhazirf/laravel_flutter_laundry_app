...
<head>
    ...
    <title>laundry-app API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-auth-login">User authentication endpoint that returns JWT token and API key.</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-auth-refresh">POST api/auth/refresh</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-auth-forgot-password">
                                <a href="#endpoints-GETapi-auth-forgot-password">GET api/auth/forgot-password</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-auth-reset-password">POST api/auth/reset-password</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-auth-generate-api-key">
                                <a href="#endpoints-POSTapi-auth-generate-api-key">POST api/auth/generate-api-key</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-auth-me">
                                <a href="#endpoints-GETapi-auth-me">GET api/auth/me</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-auth-get-outlets">
                                <a href="#endpoints-GETapi-auth-get-outlets">GET api/auth/get-outlets</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Laundry Management System API - Complete documentation for all API endpoints including authentication, outlets management, and more.</p>
<aside>
...
<div class="bash-example">
    ...
    --get "http://localhost:8181/api/documentation" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8181/api/oauth2-callback" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8181/api/oauth2-callback"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-login">User authentication endpoint that returns JWT token and API key.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;data&quot;: {
        ...
        &quot;api_key&quot;: &quot;lk_d245bca1d1f77f96c34a971759c9f7be&quot;
    }
}</code>
 </pre>
            <blockquote>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Invalid credentials&quot;
            ...
            <blockquote>
            <p>Example response (403, inactive_user):</p>
        </blockquote>
                <pre>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8181/api/auth/refresh" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-auth-forgot-password">GET api/auth/forgot-password</h2>
...
<span id="example-requests-GETapi-auth-forgot-password">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8181/api/auth/forgot-password" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8181/api/auth/forgot-password"
);
...
<span id="example-responses-GETapi-auth-forgot-password">
            <blockquote>
...
<span id="execution-results-GETapi-auth-forgot-password" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-auth-forgot-password"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-auth-forgot-password"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-auth-forgot-password" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-auth-forgot-password">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-auth-forgot-password" data-method="GET"
      data-path="api/auth/forgot-password"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-auth-forgot-password', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-auth-forgot-password"
                    onclick="tryItOut('GETapi-auth-forgot-password');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-auth-forgot-password"
                    onclick="cancelTryOut('GETapi-auth-forgot-password');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-auth-forgot-password"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-auth-forgot-password"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-auth-forgot-password"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="GETapi-auth-forgot-password"
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-auth-generate-api-key">POST api/auth/generate-api-key</h2>
...
<span id="example-requests-POSTapi-auth-generate-api-key">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8181/api/auth/generate-api-key" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-auth-generate-api-key">
</span>
<span id="execution-results-POSTapi-auth-generate-api-key" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-auth-generate-api-key"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-auth-generate-api-key"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-auth-generate-api-key" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-auth-generate-api-key">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-auth-generate-api-key" data-method="POST"
      data-path="api/auth/generate-api-key"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-auth-generate-api-key', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-auth-generate-api-key"
                    onclick="tryItOut('POSTapi-auth-generate-api-key');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-auth-generate-api-key"
                    onclick="cancelTryOut('POSTapi-auth-generate-api-key');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-auth-generate-api-key"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/auth/generate-api-key</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-auth-generate-api-key"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-auth-generate-api-key"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8181/api/auth/me" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-auth-get-outlets">GET api/auth/get-outlets</h2>
...
<span id="example-requests-GETapi-auth-get-outlets">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8181/api/auth/get-outlets" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8181/api/auth/get-outlets"
);
...
<span id="example-responses-GETapi-auth-get-outlets">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-auth-get-outlets" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-auth-get-outlets"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-auth-get-outlets"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-auth-get-outlets" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-auth-get-outlets">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-auth-get-outlets" data-method="GET"
      data-path="api/auth/get-outlets"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-auth-get-outlets', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-auth-get-outlets"
                    onclick="tryItOut('GETapi-auth-get-outlets');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-auth-get-outlets"
                    onclick="cancelTryOut('GETapi-auth-get-outlets');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-auth-get-outlets"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/auth/get-outlets</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-auth-get-outlets"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-auth-get-outlets"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
